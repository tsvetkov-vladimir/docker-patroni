...
5. Если подключать остальные узлы в рой, то для этих узлов необходимо выполнить reinit, т.к. они должны стать репликами нового мастера. Действия для включения их в конфигурацию haproxy те же самые, как это было описано выше.
